describe('User Report Incident', () => {
    ...
    it('Applicant should be able to Report Incident', function() {
        cy.scrollTo('top')
        cy.get(':nth-child(2) > .emergency_btn > .ant-card-body').click({
            force: true
        })
        cy.get(':nth-child(1) > .ant-form-item-control-wrapper > .ant-form-item-control > .ant-form-item-children > .ant-input').focus().type('Crime incident report')
