describe('SMARTJUAN24-EASE OF DOING BUSINESS', () => {
    ...
    it('Applicant should be able to sign-up in SmartJuan24 User Portal', function() {
    ...
    it('Applicant must be able to Upload Required Documents for New Business Permit', function() {
    ...
    it('Applicant must be able to Submit Application for New Business Permit', () => {
