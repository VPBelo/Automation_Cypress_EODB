describe('System Administrators', () => {
    ...
    it('Admin must be able to Login in Admin Portal Administrator Department', function() {
        ...
        cy.get(':nth-child(7) > :nth-child(2) > .ant-row > .ant-form-item-control-wrapper > .ant-form-item-control > .ant-form-item-children > .ant-input').type(this.application_details.business_area)
        cy.get(':nth-child(8) > :nth-child(1) > .ant-row > .ant-form-item-control-wrapper > .ant-form-item-control > .ant-form-item-children > .ant-input-number > .ant-input-number-input-wrap > .ant-input-number-input').type(this.application_details.employees_establishment)
        ...
        cy.get('.ant-btn-primary').click()
        cy.get('.ant-col-lg-16 > .ant-card > .ant-card-body > :nth-child(2)').click({
            force: true
        })
